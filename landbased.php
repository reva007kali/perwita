...
<body>
    ...
    <section class="landbased" id="landbased" style="background-image: url(img/landbased/landbasedbg.png);">
        <div class="landbased-content">
            <h1 class="">LAND <span>BASED</span></h1>
            <p>"Building Futures, Creating Opportunities"</p>
        </div>
        <div class="lb-cta">
            <a href="#hotel">Hotel</a>
            <a href="#constructionworker">Construction workers</a>
            <a href="#caregiver">Care giver and Maid</a>
            <a href="#factoryworker">Factory Worker</a>
            <a href="#welder">Welder</a>
        </div>
    </section>
    ...
    <section class="sb-overview" style="background-image:url(img/background/sbbg.png);">
        ...
        <div class="sb-content">
            <h1 style="font-size: 2em;">Welcome to Landbased <img src="img/logo-pn.png" alt=""></h1>
            <p>Perwita Nusaraya specializes in sending employees to various countries such as Malaysia, Taiwan, Japan,
                and Turkey, providing opportunities in a wide range of fields including hotel jobs, construction work,
                caregiving, and domestic work.</p>
                <br> 
            <p>
                Not only do they focus on overseas placements, but Perwita Nusaraya also plays a vital role in deploying
                workers within Indonesia. They connect individuals to factories, ensuring that the local workforce
                contributes effectively to the nation’s growth. Whether it’s factory work, manufacturing, or other
    ...
    <!-- lanb based services -->
    <div class="lb-services" style="background: url(img/seabased/bgseabased01.png);">
        <h1>OUR <span>SERVICES</span></h1>
        <div class="lb-container">
            <div class="lb-card" data-modal="modal1">
            ...
            <div class="lb-card" data-modal="modal2">
                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="lb-card" data-modal="modal3">
                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="lb-card" data-modal="modal4">
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 640 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path
            ...
            <div class="lb-card" data-modal="modal5">
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path
    ...
    <section class="sb-career">
        <h1 style="margin-bottom: 2rem;">LANDBASED BASED <span>CLIENTS</span></h1>
        <div class="sb-river" id="hotel">
            <div class="sb-river-img" style="background-image: url(img/landbased/pexels-enginakyurt-2767815.jpg)"></div>
            <div class="river-content" style="background-color: rgb(208, 246, 255);">
                <h1>Hotel Jobs at Turkey</h1>
                <p>Working at a hotel in Turkey offers a unique blend of professional and cultural experiences. Hotel
                    staff enjoy the vibrant hospitality industry, catering to a diverse clientele from around the world.
                    Roles can range from front desk and concierge services to housekeeping and food and beverage
                    management.</p>
                <div class="sb-clients" style="display: flex; margin-top: 2rem;">
                    <img src="img/clients/astglobal.png" alt="">
                </div>
        ...
        <div class="sb-river" id="constructionworker">
            <div class="river-content" style="background-color: rgb(255, 249, 78);">
                <h1>Construction Worker</h1>
                <p>Working as a construction worker abroad provides an opportunity for skilled laborers to gain
                    international experience, often in rapidly developing countries or regions with booming construction
                    industries.</p>
                <div class="sb-clients" style="display: flex; margin-top: 2rem;">
        ...
        <div class="sb-river" id="caregiver">
            ...
            <div class="river-content" style="background-color: rgb(208, 246, 255);">
                ...
                <p>In these countries, caregivers assist with daily living activities, provide medical support, and
                    offer companionship, primarily to the elderly. Jobs typically require basic caregiving skills and
                    empathy. Benefits often include competitive salaries, accommodation, and meals.</p>
                <div class="sb-clients" style="display: flex;">
                    <ul style="list-style: circle;">
                        <li>Sung Care Employment Agency</li>
                        <li>Wingfai Employment Limited</li>
                        <li> Maxwell International Employment Agency</li>
                        <li>Get Maid Agency</li>
                        <li>Wecarehelpers Employment Agency</li>
        ...
        <div class="sb-river" id="welder">
            <div class="river-content" style="background-color: rgb(232, 230, 230);">
                <h1>Welder</h1>
                <p>Welders trained and deployed by Perwita Nusaraya Group are highly skilled professionals equipped to
                    meet the rigorous demands of various industries. Their expertise spans a wide range of welding
                    techniques, including MIG, TIG, Stick, and Flux-Cored Arc Welding (FCAW), allowing them to work
                    efficiently with different materials such as steel, aluminum, and stainless steel.</p>
                <div class="sb-clients" style="display: flex; margin-top: 2rem;">
            ...
            <div class="sb-river-img"
                style="background-image: url(img/landbased/welder.jpg); background-position: 0px -50px;"></div>
        </div>

        <div class="sb-river" id="factoryworker">
            <div class="river-content" style="background-color: rgb(255, 249, 78);">
                <h1>Factory Worker</h1>
                <p>Factory workers in large factories in Indonesia play a crucial role in the country's industrial
                    sector, contributing significantly to its economic growth. These workers are involved in various
                    stages of the manufacturing process, from assembling and operating machinery to quality control and
                    packaging. Typically, they work in sectors such as textiles, electronics, automotive, and consumer
                    goods.</p>
                <div class="sb-clients" style="display: flex; margin-top: 2rem;">
                    <img src="img/clients/maxwell.png" alt="">
        ...
        <div class="sb-river" id="">
            <div class="sb-river-img"
                style="background-image: url(img/landbased/securitystaff.JPG); background-position: 0px -50px;"></div>
            <div class="river-content" style="background-color: rgb(208, 246, 255);">
                <h1>Security Staffs</h1>
                <p>Security staff in Indonesia play a vital role in maintaining safety and order across various sectors,
                    including residential, commercial, and industrial settings. These professionals are responsible for
                    protecting property, assets, and individuals from potential threats such as theft, vandalism, and
    ...
    <section class="lb-deployed" style="background: url(img/seabased/bgseabased01.png);">
        <h1>Land Based <span>Deployed Numbers</span></h1>
    ...
    <section class="licenses" style="background-image: url(img/background/licensesbg.jpg);">
        ...
        <div class="licenses-container">
            <div class="licenses-card slide-up" data-license="ISO 9001:2015"
            ...
            <!-- <div class="licenses-card slide-up" data-license="SIUPAK" data-description="Ministry of Transportation"
          ...
          <p>Ministry of Transportation</p>
            ...
            <!-- <div class="licenses-card slide-up" data-license="MLC 2006" data-description="Maritime Labour Convention"
          ...
          <p>Maritime Labour Convention</p>
            ...
            <!-- <div class="licenses-card slide-up" data-license="MTC" data-description="Maritime Training Center"
          ...
          <p>Maritime Training Center</p>
            ...
            <!--   
        <div class="licenses-card slide-up" data-license="Jae Hwa Legalization"
          ...
          <p>Fisherman for South Korea</p>
            ...
            <div class="licenses-card slide-up" data-license="BP2MI" data-description="Ministry of Manpower"
            ...
            <!--   
        <div class="licenses-card slide-up" data-license="Sending organization" data-description="Licence for Japan"
          ...
          <p>Licence for Japan</p>
            ...
            <div class="licenses-card slide-up" data-license="NIB" data-description="Business Identification Number"
    ...
    <section class="post-update slide-up" style="background-image: url(img/background/socialmediabg.png);">
        <div class="sm-tittle">
            ...
            <h1 class="slide-up">Follow Our <span>Social Media</span></h1>
        ...
        <div class="post slide-up">
            <img src="img/landbased/lb-sm/lbsm1.jpg" alt="" onclick="openImageModal(this)">
            <img src="img/landbased/lb-sm/lbsm2.jpg" alt="" onclick="openImageModal(this)">
            <img src="img/landbased/lb-sm/lbsm3.jpg" alt="" onclick="openImageModal(this)">
            <img src="img/landbased/lb-sm/lbsm4.jpg" alt="" onclick="openImageModal(this)">
            <img src="img/landbased/lb-sm/lbsm5.jpg" alt="" onclick="openImageModal(this)">
        </div>
        ...
        <div class="footer-content-container">
            ...
            <div class="contact-form">
                ...
                <div class="sm-icons">
                    ...
                    <div class="sm-icons-button">
                        <a href="https://www.instagram.com/perwitanusaraya.manning/?hl=en" target="_blank"><img
                                src="img/icon/ig.png" alt=""></a>
                        <a href="https://www.facebook.com/PTPerwitaNusaraya/?locale=id_ID" target="_blank"><img
                                src="img/icon/fb.png" alt=""></a>
                        <a href="https://id.linkedin.com/company/pt-perwita-nusaraya?trk=ppro_cprof"
