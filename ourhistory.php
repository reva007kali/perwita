...
<body>
  ...
  <section class="about-home" style="background-image:url(img/founder/backdrop\ units\ \(3\).png);background-position: top;">

    <div class="about-content">
      <h1 style="font-size: 5em;">OUR HISTORY</span></h1>
  ...
  <!-- content -->
  <section class="history" id="history" style="background: url(img/background/bghistory.jpg);">
    <h1>Founded in <span>August 1994</span> by 
      <br>
      <span>Ibu Sri Murtiningsih</span>
    </h1>
    <div class="history-founded">
      <div class="history-content">
        <p><strong>Perwita Nusaraya Group began with a mission driven by empathy and a deep concern for Indonesian
      ...
      <div class="history-img-frame">
        ...
        <h5>"Ibu Sri Murtiningsih Founder of Perwita Nusaraya Group with Bapak Soeharto, Former President of the Republic
          of Indonesia"</h5>
      </div>
    </div>
    <div class="history-founded">
      <div class="history-img-frame">
        <img src="img/gallery/33.jpg" alt="" style="width: fit-content;">
        <h5>"Indonesian Expo at Warszawa , Poland Eastern European held by the Goverment of The Republic of Indonesia"
        </h5>
      </div>
      <div class="history-content">
    ...
    <div class="history-founded">
      ...
      <div class="history-img-frame">
        <img src="img/gallery/40.jpg" alt="" style="width: fit-content;">
        <h5>"Perwita attended a labor event organized by the Indonesian government in Indonesia."
        </h5>
      </div>
    </div>
    <div class="history-founded">
      ...
      <div class="history-img-frame">
        <img src="img/gallery/20.jpg" alt="" style="width: fit-content;">
        <!-- <h5>"Perwita attended a labor event organized by the Indonesian government in Indonesia."
        </h5> -->
      </div>
      <div class="history-img-frame">
        <img src="img/gallery/21.jpg" alt="" style="width: fit-content;">
        <!-- <h5>"Perwita attended a labor event organized by the Indonesian government in Indonesia."
        </h5> -->
      </div>
      <div class="history-img-frame">
        <img src="img/gallery/39.jpg" alt="" style="width: fit-content;">
        <!-- <h5>"Perwita attended a labor event organized by the Indonesian government in Indonesia."
        </h5> -->
      </div>
    </div>
